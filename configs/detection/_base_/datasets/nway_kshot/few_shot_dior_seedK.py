...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=True,
        dataset=dict(
            type='FewShotDIORDefaultDatasetWithSeedK',
            ann_cfg=[
                dict(
                    type='ann_file', ann_file=data_root + 'ImageSets/Main/trainval.txt')
            ],
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file', ann_file=data_root + 'ImageSets/Main/test.txt')
        ],
        img_prefix=data_root,
    ...
    test=dict(
        type='FewShotDIORDataset',
        ann_cfg=[dict(type='ann_file', ann_file=data_root + 'ImageSets/Main/test.txt')],
        img_prefix=data_root,
        pipeline=test_pipeline,
        test_mode=True,
        classes=None),
