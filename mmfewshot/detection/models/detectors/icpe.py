...
class ICPE(QuerySupportDetector):
    ...
    def __init__(self,
        ...
        if information_coupling is not None:
            ...
            self.information_coupling = build_information_coupling(
    ...
    def forward_train(self,
        ...
        if not self.with_information_coupling:
            ...
            for img_id in range(batch_size):
                query_feats_ = (query_feats[0][img_id].unsqueeze(0)).repeat(
                    num_support, 1, 1, 1)
                support_feats_ = self.information_coupling(
                    support_feats_origin[0], query_feats_)
    ...
    def model_init(self):
        ...
        for class_id in class_ids:
            ...
            self.inference_support_feats_dict[class_id] = feats[gt_labels ==
                                                                class_id]
    ...
    def simple_test(self,
        ...
        for class_id, sup_feats in self.inference_support_feats_dict.items():
            if sup_feats.size(0) > 30:
                ...
                feats = sup_feats
            support_feats = self.information_coupling(
                feats, query_feats[0].repeat(feats.size(0), 1, 1, 1))
