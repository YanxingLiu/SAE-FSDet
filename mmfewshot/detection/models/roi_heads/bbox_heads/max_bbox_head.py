...
from ...backbones.vision_transformer_bytedance import Block, trunc_normal_
...
class MAEBBoxHead(BBoxHead):
    ...
    def init_weights(self, pretrained):
        ...
        if os.path.isfile(pretrained):
            logger.info(f'loading checkpoint for {self.__class__}')
    ...
    def forward(self, x):
        ...
        x = x + self.interpolate_pos_encoding(x, W * self.patch_size,
                                              H * self.patch_size)[:, 1:, :]
