...
from .base_model import ViTAE_RSP
...
# @register_model
def ViTAE_Window_NoShift_12_basic_stages4_14(
        pretrained=False, **kwargs):  # adopt performer for tokens to token
    # if pretrained:
    # kwargs.setdefault('qk_scale', 256 ** -0.5)
    model = ViTAE_Window_NoShift_basic(
