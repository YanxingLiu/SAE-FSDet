...
class FewShotF2ODDataset(BaseFewShotDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        for img_id in img_ids:
            ...
            xml_path = osp.join(self.img_prefix, 'all_xmls_800_00',
                                f'{img_id}.xml')
...
@DATASETS.register_module()
class FewShotF2ODCopyDataset(FewShotF2ODDataset):
    ...
    def ann_cfg_parser(self, ann_cfg: Union[List[Dict], Dict]) -> List[Dict]:
        ...
        if isinstance(ann_cfg, dict):
            assert ann_cfg.get('data_infos', None) is not None, \
                ...
                f'FewShotF2ODDataset require data_infos.'
