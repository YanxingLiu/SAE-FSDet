...
def parse_args():
    ...
    parser.add_argument('--f2od', action='store_true', help='For F2OD models')
    parser.add_argument(
        '--vhr10', action='store_true', help='For vhr10 models')
...
def main():
    ...
    if args.coco:
        ...
        TAR_SIZE = F2OD_TAR_SIZE
    elif args.vhr10:
        TAR_SIZE = VHR10_TAR_SIZE
    else:
